...
import org.spring.consant.EmpRestURIConstants;
import org.spring.model.Employee;
import org.spring.model.EmployeeAddress;
...
public class EmployeeController {
    ...
    Employee getDummyEmployee() {
        ...
        emp.setOrganization("XYZ Company");
        emp.setDesignation("Associate");

        ArrayList<EmployeeAddress> addList = new ArrayList<EmployeeAddress>();
        EmployeeAddress empADD = new EmployeeAddress();
        empADD.setCity("kolkata");
        empADD.setPost("Salt Lake");
        empADD.setPinCode(721301);
        empADD.setState("West Bangal");
        addList.add(empADD);

        emp.setEmpADD(addList);
